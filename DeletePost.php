            ...
            <div class="page-header">
                ...
                <?php
                    ...
                    WHILE ($DataRows=mysqli_fetch_array($ExecuteQuery)){
                        ...
                        $delpost="Uploads/images/$ImageToUpdated";
                        $DeleteFromURL = $_GET['id'];
                        $Query = "DELETE FROM admin_panel where id='$DeleteFromURL' ";
                ...
                <form action="DeletePost.php?id=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input disabled class="form-control" type="text" name="Title" id="title" placeholder="Titlu" value="<?php echo $TitleToUpdated ?>" >
                        </div>
...
<!--                        inceput imagine-->
                        <div class="form-group col-sm-12 col-lg-8">
                            ...
                            <select disabled class="form-control" id="categoryselect" name="Category"   placeholder="Selecteaza categoria" >
                                <?php
                            ...
                            <label for="imageSelect"><span class="FieldInfo">Alege o alta imagine:</span></label>
                                <input disabled type="File"  class="form-control" name="Image" id="imageSelect" accept="image/jpeg,image/png,image/gif" >
